...
#+begin_src emacs-lisp
  (use-package cape
    :bind (:map st/prefix-map ("p" . hydra-cape/body))
    :init
...
#+begin_src emacs-lisp
  (use-package expand-region
    :bind (:map st/prefix-map ("e" . hydra-expand-region/body))
    :config
...
#+begin_src emacs-lisp
  (use-package move-text
    :bind (:map st/prefix-map ("m" . hydra-move-text/body))
    :config
...
#+begin_src emacs-lisp
  (use-package multiple-cursors
    :bind (:map st/prefix-map ("c" . hydra-multiple-cursors/body))
    :config
...
#+begin_src emacs-lisp
  (use-package emacs
    :bind (:map st/prefix-map ("o" . hydra-org-mode/body))
    :config
...
#+begin_src emacs-lisp
  (let ((st/mu4e-config "~/.emacs.d-mu4e/mu4e-config.org"))
    (when (and (executable-find "mu")
               (file-exists-p (expand-file-name st/mu4e-config)))
      (org-babel-load-file (expand-file-name st/mu4e-config))))
#+end_src
