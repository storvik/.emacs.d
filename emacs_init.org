...
** [[https://github.com/rranelli/auto-package-update.el][Auto update packages]]
...
#+begin_src emacs-lisp
  (use-package smart-mode-line
    ...
    (add-to-list 'sml/replacer-regexp-list '("^:dev:golang/" ":go:") t)
...
*** [[https://github.com/MaskRay/ccls][ccls installation]]
...
#+begin_src shell
  ...
  cd ../
  make -H. -BRelease -G Ninja -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_COMPILER=clang++ \
