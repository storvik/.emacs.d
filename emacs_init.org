...
#+begin_src emacs-lisp
  (org-babel-load-file (expand-file-name (sys-diversification
                                          "emacs_linux.org"
                                          "emacs_darwin.org"
                                          "emacs_windows.org")
...
#+begin_src emacs-lisp
  (defun find-init-file ()
    ...
    (let ((my-init-file (completing-read "Open init file: " '(init linux darwin windows unix))))
      (unless (file-exists-p (expand-file-name (format "emacs_%s.org" my-init-file) user-emacs-directory))
        (error (format "Could not find specified init file: emacs_%s.org" my-init-file)))
      (find-file (expand-file-name (format "emacs_%s.org" my-init-file) user-emacs-directory))))
