...
#+begin_src emacs-lisp
  (use-package lsp-mode
    ...
    (setq lsp-keymap-prefix "C-c l"
          ;; lsp-prefer-capf t          ;; corfu / orderless fix
          lsp-completion-provider :none ;; corfu / orderless fix
          lsp-prefer-flymake nil
          lsp-auto-execute-action nil
          lsp-enable-indentation nil)
    :config
    (defun corfu-lsp-setup ()
      "corfu / orderless fix, see https://www.reddit.com/r/emacs/comments/ql8cyp/corfu_orderless_and_lsp/"
...
#+begin_src emacs-lisp
  (use-package apheleia
    ...
    (setf (alist-get 'clang-format apheleia-formatters)
          '("clang-format" "-style={BasedOnStyle: Google, IndentWidth: 4}" file))
...
#+begin_src emacs-lisp
  ...
  ^org^                     ^roam^                                         ^dailies
  ^^^^^^^^---------------------------------------------------------------------------------------------
  _a_: agenda               _l_: buffer toggle        _f_: find              _j_: capture dailies
  _C_: capture              _c_: capture              _i_: insert node       _t_: goto today
  ^ ^                       _u_: roam ui              ^ ^                    _y_: goto yesterday
  ^ ^                       _s_: roam ripgrep         ^ ^                    _d_: goto day
  "
      ("a" org-agenda)
      ("C" org-capture)
