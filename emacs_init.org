...
** [[https://github.com/manateelazycat/grammatical-edit][Grammatical edit]]
...
#+begin_src emacs-lisp
  (use-package grammatical-edit
    ...
    :hook ((c-mode-common
            ...
            typescript-mode) . grammatical-edit-mode)
    :bind ((:map grammatical-edit-mode-map
            ...
            ("C-M-\"" . grammatical-edit-wrap-double-quote)
            ("C-M-[" . grammatical-edit-wrap-bracket)
            ("C-M-{" . grammatical-edit-wrap-curly)
            ("C-M-(" . grammatical-edit-wrap-round)
            ("C-M-)" . grammatical-edit-unwrap)

            ("C-M-p" . grammatical-edit-jump-right)
            ("C-M-n" . grammatical-edit-jump-left)
            ("C-M-:" . grammatical-edit-jump-out-pair-and-newline))))
#+end_src
  ...
  (setq org-capture-templates
        (quote (("t" "Todo" entry (file "~/developer/org/org/refile.org")
                ...
                ("k" "Cliplink bookmark" entry (file "~/developer/org/org/bookmarks.org")
                 "* %(org-cliplink-capture)%?\n" :unnarrowed t :empty-lines-before 0)
                )))
#+end_src
