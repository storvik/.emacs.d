...
#+begin_src emacs-lisp
  ...
  (defun storvik/overrides-minibuffer-setup-hook ()
    (storvik/overrides-minor-mode 0))

  (add-hook 'minibuffer-setup-hook 'storvik/overrides-minibuffer-setup-hook)
#+end_src
...
#+begin_src emacs-lisp
  (use-package ryo-modal
    ...
    (ryo-modal-keys
     ...
     ("y" yank)
     ("m"
      (("f" forward-char :name "Forward char")
       ("b" backward-char :name "Backward char")))
     ("w"
      (("W" kill-ring-save :name "Copy selection")))
     ("k"
      (("k" kill-line :name "Kill line"))))
